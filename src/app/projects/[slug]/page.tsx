...
const PROJECT_DETAIL_LINK_ICONS = {
  github: (
    <svg className="h-4 w-4 transition-transform duration-300 ease-soft group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
  ...
  demo: (
    <svg className="h-4 w-4 transition-transform duration-300 ease-soft group-hover:-translate-y-[1px] group-hover:translate-x-[1px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
    </svg>
  ),
  figjam: (
    <svg className="h-4 w-4 transition-transform duration-300 ease-soft group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">

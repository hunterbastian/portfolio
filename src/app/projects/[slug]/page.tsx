              ...
              <div className="mb-12 flex flex-wrap gap-3">
                {frontmatter.github && (
                  <TrackedExternalLink
                    ...
                    projectSlug={slug}
                    projectTitle={displayTitle}
                    className="group inline-flex items-center gap-2 font-inter text-[13px] font-medium text-primary transition-[color,transform] duration-300 ease-soft hover:text-accent hover:-translate-y-[2px]"
                  >

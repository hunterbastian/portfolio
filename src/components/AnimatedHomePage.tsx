...
function ContactLink({ link }: { link: ContactLinkItem }) {
  return (
    <motion.a
      ...
      className="inline-flex items-center justify-center gap-2 px-6 py-3 font-medium text-sm text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 rounded-sm transition-colors duration-300 hover:bg-gray-50 dark:hover:bg-gray-900"
      whileHover={{ y: -1 }}

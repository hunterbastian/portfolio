   ...
   >
     ...
     <div className="max-w-2xl mx-auto">
       <div className="grid grid-cols-2 sm:flex sm:flex-row gap-5 sm:gap-6 justify-center items-center sm:items-center">
         {/* Contact buttons with Mac OS Aqua styling */}
         <motion.a
           ...
           onMouseEnter={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(147, 197, 253, 1) 0%, rgba(59, 130, 246, 0.9) 50%, rgba(37, 99, 235, 1) 100%)`;
             e.currentTarget.style.boxShadow = `0 6px 20px rgba(37, 99, 235, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(37, 99, 235, 0.7)`;
           }}
           onMouseLeave={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(147, 197, 253, 0.9) 0%, rgba(59, 130, 246, 0.8) 50%, rgba(37, 99, 235, 0.9) 100%)`;
             e.currentTarget.style.boxShadow = `0 4px 16px rgba(37, 99, 235, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(37, 99, 235, 0.5)`;
           }}
         >
         ...
         <motion.a
           ...
           transition={{ duration: 0.3, ease: "easeOut" }}
           onMouseEnter={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(156, 163, 175, 1) 0%, rgba(75, 85, 99, 0.9) 50%, rgba(55, 65, 81, 1) 100%)`;
             e.currentTarget.style.boxShadow = `0 6px 20px rgba(55, 65, 81, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(55, 65, 81, 0.7)`;
           }}
           onMouseLeave={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(156, 163, 175, 0.9) 0%, rgba(75, 85, 99, 0.8) 50%, rgba(55, 65, 81, 0.9) 100%)`;
             e.currentTarget.style.boxShadow = `0 4px 16px rgba(55, 65, 81, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(55, 65, 81, 0.5)`;
           }}
         >
         ...
         <motion.a
           ...
           transition={{ duration: 0.3, ease: "easeOut" }}
           onMouseEnter={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(115, 115, 115, 1) 0%, rgba(51, 51, 51, 0.9) 50%, rgba(34, 34, 34, 1) 100%)`;
             e.currentTarget.style.boxShadow = `0 6px 20px rgba(34, 34, 34, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(34, 34, 34, 0.7)`;
           }}
           onMouseLeave={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(115, 115, 115, 0.9) 0%, rgba(51, 51, 51, 0.8) 50%, rgba(34, 34, 34, 0.9) 100%)`;
             e.currentTarget.style.boxShadow = `0 4px 16px rgba(34, 34, 34, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(34, 34, 34, 0.5)`;
           }}
         >
           <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
         ...
         <motion.a
           ...
           transition={{ duration: 0.3, ease: "easeOut" }}
           onMouseEnter={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(244, 114, 182, 1) 0%, rgba(234, 76, 137, 0.9) 50%, rgba(219, 39, 119, 1) 100%)`;
             e.currentTarget.style.boxShadow = `0 6px 20px rgba(219, 39, 119, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(219, 39, 119, 0.7)`;
           }}
           onMouseLeave={(e) => {
             e.currentTarget.style.background = `linear-gradient(180deg, rgba(244, 114, 182, 0.9) 0%, rgba(234, 76, 137, 0.8) 50%, rgba(219, 39, 119, 0.9) 100%)`;
             e.currentTarget.style.boxShadow = `0 4px 16px rgba(219, 39, 119, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(219, 39, 119, 0.5)`;
           }}
         >
           <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
         ...
         <div className="relative">
           <motion.button
             ...
             transition={{ duration: 0.3, ease: "easeOut" }}
             onMouseEnter={(e) => {
               e.currentTarget.style.background = `linear-gradient(180deg, rgba(148, 163, 184, 1) 0%, rgba(100, 116, 139, 0.9) 50%, rgba(71, 85, 105, 1) 100%)`;
               e.currentTarget.style.boxShadow = `0 6px 20px rgba(71, 85, 105, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(71, 85, 105, 0.7)`;
               setShowResumePreview(true);
             }}
             onMouseLeave={(e) => {
               e.currentTarget.style.background = `linear-gradient(180deg, rgba(148, 163, 184, 0.9) 0%, rgba(100, 116, 139, 0.8) 50%, rgba(71, 85, 105, 0.9) 100%)`;
               e.currentTarget.style.boxShadow = `0 4px 16px rgba(71, 85, 105, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(71, 85, 105, 0.5)`;

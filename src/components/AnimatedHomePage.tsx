...
function ContactLink({ link }: { link: ContactLinkItem }) {
  return (
    <motion.a
      ...
      className="contact-button inline-flex items-center justify-center rounded-xl w-full sm:w-8 h-10 sm:h-8 px-3 sm:px-0 gap-2 sm:gap-0 font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-white relative overflow-hidden touch-manipulation"
      style={{
        '--contact-gradient': link.gradient,
        '--contact-gradient-hover': link.hoverGradient,
        '--contact-border': link.border,
        '--contact-shadow': link.shadow,
        '--contact-shadow-hover': link.hoverShadow
      } as CSSProperties}
    ...
    >
      {link.icon}
      <span className="text-xs sm:hidden font-medium" style={{ fontSize: '10px' }}>
        {link.label}
      </span>
    </motion.a>
  )
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-row gap-5 sm:gap-6 justify-center items-center sm:items-center">
          ...
          <div className="relative">
            <motion.button
              ...
              className="contact-button inline-flex items-center justify-center rounded-xl px-3 py-2 font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring whitespace-nowrap relative overflow-hidden cursor-pointer text-white"
              style={{
                '--contact-gradient': 'linear-gradient(180deg, rgba(148, 163, 184, 0.9) 0%, rgba(100, 116, 139, 0.8) 50%, rgba(71, 85, 105, 0.9) 100%)',
                '--contact-gradient-hover': 'linear-gradient(180deg, rgba(148, 163, 184, 1) 0%, rgba(100, 116, 139, 0.9) 50%, rgba(71, 85, 105, 1) 100%)',
                '--contact-border': 'rgba(148, 163, 184, 0.6)',
                '--contact-shadow': '0 4px 16px rgba(71, 85, 105, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 rgba(71, 85, 105, 0.5)',
                '--contact-shadow-hover': '0 6px 20px rgba(71, 85, 105, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.9), inset 0 -1px 0 rgba(71, 85, 105, 0.7)',
                fontSize: '9px'
              } as CSSProperties}

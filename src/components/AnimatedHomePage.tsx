...
export default function AnimatedHomePage({ children }: AnimatedHomePageProps) {
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-8">
      ...
      >
        <div className="max-w-2xl mx-auto hero-section">
                {/* Profile Picture */}
                <motion.div
                ...
                <motion.h1
                 className="mb-6 text-black dark:text-white font-playfair italic text-left motion-element"
     ...
     <div className="max-w-2xl mx-auto">
       <div className="flex flex-col sm:flex-row gap-4 justify-start">
         <motion.a
           ...
           className="inline-flex items-center justify-center rounded-md w-10 h-10 font-medium shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-[#0A66C2] relative overflow-hidden"
           style={{
         ...
         <motion.a
           ...
           target="_blank"
           rel="noopener noreferrer"
           className="inline-flex items-center justify-center rounded-md w-10 h-10 font-medium shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-[#333] relative overflow-hidden"
           style={{
         ...
         <motion.a
           ...
           target="_blank"
           rel="noopener noreferrer"
           className="inline-flex items-center justify-center rounded-md w-10 h-10 font-medium shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-[#000] relative overflow-hidden"
           style={{
         ...
         <motion.a
           ...
           target="_blank"
           rel="noopener noreferrer"
           className="inline-flex items-center justify-center rounded-md w-10 h-10 font-medium shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-[#ea4c89] relative overflow-hidden"
           style={{

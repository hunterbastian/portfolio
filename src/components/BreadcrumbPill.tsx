...
export default function BreadcrumbPill({ href, parentLabel, currentLabel }: BreadcrumbPillProps) {
  return (
    <Link
      href={href}
      className="group inline-flex items-center gap-2 backdrop-blur-xl px-5 py-2.5 top-meta-pill font-mono text-[11px] tracking-[0.12em] text-muted-foreground transition-colors duration-200 hover:text-foreground"
    >

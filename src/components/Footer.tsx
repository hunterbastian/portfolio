    ...
    >
      <div className="container mx-auto max-w-6xl">
        <div className="flex items-center justify-between py-1">
          <span className="inline-flex items-center gap-2 text-[9px] tracking-[0.08em] font-mono text-foreground/70">
            <span
          ...
          <span className="group/heart text-[9px] tracking-[0.08em] font-mono text-foreground/70 cursor-default">

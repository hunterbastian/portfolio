...
test('home hero local time stays a quiet 24-hour Mountain Time meta line', () => {
  ...
  assert.match(HOME_HERO_LOCATION_META_CLASS_NAME, /text-\[12px\]/)
  ...
  assert.match(HOME_HERO_LOCATION_LABEL_CLASS_NAME, /tracking-\[0\.12em\]/)
...
test('home hero name is one step larger with display tracking and a real medium weight', () => {

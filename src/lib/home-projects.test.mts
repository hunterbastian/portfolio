...
test('formatProjectYear and getProjectAccent stay monochrome for row chrome', () => {
  ...
  assert.match(HOME_FEATURED_ROW_META_CLASS_NAME, /text-\[12px\]/)
  ...
  assert.match(HOME_FEATURED_ROW_OUTCOME_CLASS_NAME, /text-\[14px\]/)
  ...
  assert.match(HOME_MORE_ROW_TITLE_CLASS_NAME, /text-\[16px\]/)
  assert.match(HOME_MORE_ROW_META_CLASS_NAME, /text-\[12px\]/)
})

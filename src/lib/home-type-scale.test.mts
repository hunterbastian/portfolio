...
test('homepage type scale keeps an Apfel name and readable section labels', () => {
  ...
  assert.match(HOME_HERO_NAME_CLASS_NAME, /font-medium/)
  ...
  assert.match(HOME_HERO_INTRO_CLASS_NAME, /leading-\[1\.6\]/)
  assert.match(HOME_PHILOSOPHY_BODY_CLASS_NAME, /font-normal/)
  assert.match(HOME_PHILOSOPHY_BODY_CLASS_NAME, /leading-\[1\.6\]/)
  ...
  assert.match(HOME_FEATURED_ROW_TITLE_CLASS_NAME, /text-\[18px\]/)
  ...
  assert.match(HOME_HERO_CONTACT_LINE_CLASS_NAME, /leading-\[1\.6\]/)
  assert.doesNotMatch(HOME_HERO_CONTACT_LINE_CLASS_NAME, /font-semibold/)
  assert.match(playground, /font-pixel/)
})

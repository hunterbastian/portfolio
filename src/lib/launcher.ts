...
export const LAUNCHER_TITLE = 'Commands'
export const LAUNCHER_DIALOG_ARIA_LABEL = 'Command palette'
export const LAUNCHER_CLOSE_ARIA_LABEL = 'Close command palette'
export const LAUNCHER_SEARCH_ARIA_LABEL = 'Search commands'
export const LAUNCHER_COMMAND_LIST_ARIA_LABEL = 'Commands'
export const LAUNCHER_OPEN_TOAST = 'Command palette opened'
